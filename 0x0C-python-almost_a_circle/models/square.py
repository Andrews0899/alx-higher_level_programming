...
class Rectangle(Base):
    ...
    def __init__(self, width, height, x=0, y=0, id=None):
        ...
        Args:
            ...
            x (int, optional): x-coordinate of the
            rectangle's position. Defaults to 0.
            y (int, optional): y-coordinate of the
            rectangle's position. Defaults to 0.
    ...
    def validate_integer(self, name, value, eq=True):
        '''
        Validates if a value is an integer and satisfies
        certain conditions.

        Args:
            name (str): Name of the property.
            value: Value to be validated.
            eq (bool, optional): Indicates if value can be equal to
            0. Defaults to True.
